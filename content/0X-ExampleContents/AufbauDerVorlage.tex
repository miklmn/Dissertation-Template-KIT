...
\texttt{./Diss.tex}                       & \texttt{TeX}-Hauptdatei
                                          & Aus- und Einblenden der einzelnen Teile durch Ersetzen von \lc{showif} durch \lc{hideif} und vice versa.\\
%-----------------------------------------------------------------------------------------------------
...
\texttt{./preamble/Header.tex}            & Präambel-Definitionen
                                          & Hier könnte das A4-Layout und die \printkeyword{draft}-Option aktiviert werden.\\
%-----------------------------------------------------------------------------------------------------
...
Zusätzliche Pfade können in der Datei \printfilepath{./preamble/AllePfade.tex} definiert werden.
...
finden sich in der Datei \printfilepath{./preamble/AlleAngaben.tex}.
