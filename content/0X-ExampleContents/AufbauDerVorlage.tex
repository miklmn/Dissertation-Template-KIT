...
Außerdem wird hier die \index{Sprache!Hauptsprache}Hauptsprache der Arbeit gesetzt, was sich an mehreren Stellen auswirkt.
...
Neben diesen Einstellungen werden in der Datei \printfilepath{./preambel/AlleAngaben.tex} auch Einstellungen,
die für die Vorbereitung des Manuskriptes zum Druck beim \gls{ac:KSP} wichtig sind, gesetzt.
