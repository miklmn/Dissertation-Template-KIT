...
%
%% No need for a separate bookmark (dove via toc)
...
\myNotationDescTableEntry{Vectors}{bold Roman lowercase letters}{\symbf{t}}
\myNotationDescTableEntry{Matrices}{bold Roman uppercase letters}{\symbf{R}}
\myNotationDescTableEntry{State spaces}{bold calligraphic Roman uppercase letters}{{\statespace}}
\myNotationDescTableEntry{Random variables}{italic Roman uppercase letters}{E}
\myNotationDescTableEntry{Multi-dimensional random variables}{bold italic Roman uppercase letters}{\symbfit{E}}
...
\myNotationTableEntryMath{{\chi}^2_{n}}{n-dimensional chi-square distribution}
%
\end{myNotationTable}
