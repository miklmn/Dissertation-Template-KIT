...
%% mit BibLaTeX:
\appto{\bibsetup}{\RaggedRight} %Flattersatz, Silbentrennung zulassen
%\appto{\bibsetup}{\raggedright} %Flattersatz, keine Silbentrennung zulassen
...
%
\input{content/Z0-Appendix/Derivations.tex}
%
