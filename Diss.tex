...
%%% Call order: xelatex | biber | makeglossaries | xelatex | xelatex
%%%
%% !TeX encoding = utf8
%% !TeX program = xelatex
%% !BIB program = biber
...
%
%% Add own contents with  \input{content\ChapterX} or \include{content\ChapterX}
%% as shown below. The files listed below could be used as templates:
%
