...
\setlength{\myintextsep}{2\baselineskip} % (default 12pt plus 2pt minus 2pt) 
...
% Abstand zwischen den Fußnoten und dem Text
\newlength{\myfootnoteskip}
\setlength{\myfootnoteskip}{1.5\baselineskip}
